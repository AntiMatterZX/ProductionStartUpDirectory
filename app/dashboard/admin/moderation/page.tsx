...
import { ApprovalButtons } from "@/app/dashboard/admin/components/ApprovalButtons"
import { cookies } from "next/headers"

export default async function ModerationPage() {
  // Use cookies directly as recommended in Next.js docs
  ...
  if (userRole !== "admin") {
    console.log("User role check failed in page component:", userRole);
    return notFound()
  }
